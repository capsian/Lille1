...
echo " create new vol; sec=1, cyl=0, blocs=10"
../build/bin/mkvol -s 1 -c 0 -b 10
echo ""
echo " create new vol; sec=12, cyl=0, blocs=15"
../build/bin/mkvol -s 12 -c 0 -b 15
echo ""
echo " create new vol; sec=10, cyl=0, blocs=20"
../build/bin/mkvol -s 13 -c 10 -b 20
echo ""
