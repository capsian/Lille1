...
sudo -u admin bash -c 'echo -e "1002:admin:\n1003:lambda_a:\n1004:lambda_b:" > /home/admin/passwd'
sudo -u admin bash -c 'chmod o-rwx /home/admin/passwd'

echo "Compiling rmg"
make
echo "Setting rmg permissions: owned by admin and set-uid for users"
sudo chown admin rmg
sudo chmod +x,u+s rmg
